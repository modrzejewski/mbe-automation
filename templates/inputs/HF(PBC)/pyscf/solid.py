...
#
GridSize = [{KPOINT_NX}, {KPOINT_NY}, {KPOINT_NZ}]
GammaCentered = {KPOINT_GAMMA_CENTERED}
XYZFile = "solid.xyz"
...
#
# k-point coordinates passed to pyscf must be absolute,
# that is, multiplied by the reciprocal lattice vectors
#
ScaledKPoints = mbe_automation.kpoints.ScaledKPoints(GridSize, GammaCentered)
AbsKPoints = cell.get_abs_kpts(ScaledKPoints)
#
...
#
mean_field = pbc_scf.KRHF(cell, kpts=AbsKPoints, exxdiv="ewald").jk_method("RS")
#

...
class DynamicsConfig:
    """
    Configuration class for lattice molecular dynamics or path-integral
    molecular dynamics simulation.
    """
                                   #
                                   # Initial unit cell in the MD/PIMD
                                   # simulation
                                   #
    unit_cell: Atoms
                                   #
                                   # Initial configuration of the isolated
                                   # molecule in the MD/PIMD simulation
                                   #
    molecule: Atoms
                                   #
    ...
    hdf5_dataset: str = "./dynamics.hdf5"
                                   #

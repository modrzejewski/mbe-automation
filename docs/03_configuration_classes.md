...
| `transform_relaxed_crystal` | Refines the space group symmetry after each geometry relaxation. Can be `"symmetrized_primitive_cell"`, `"symmetrized_conventional_cell"`, or `"no_transformation"`.             | `"symmetrized_primitive_cell"`              |

...
| **`frequencies_and_eigenvectors`** | Calculates phonon frequencies and eigenvectors at specific k-points. Supports band tracking via `track_bands=True` and `degenerate_freqs_tol_cm1`. | `ForceConstants` |

...
| `pressure_GPa`                  | External pressure (GPa) for thermodynamic analysis. If `thermal_expansion=True`, determines the equilibrium volume by minimizing Gibbs Free Energy: G(V) = F(V) + pV. | `0.0`                                           |

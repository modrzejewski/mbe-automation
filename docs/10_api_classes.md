...
| **`Trajectory`** | Represents the time evolution of an atomistic system generated with molecular dynamics. Includes time-dependent properties, e.g., positions, velocities, cell volumes, and contributions to the average energy components. |
